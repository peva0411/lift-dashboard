...
class Topbar extends Component {
  ...
  current = () => {
    ...
    if(this.props.currentPath === '/clients') {
      return 1
    }
              ...
              <Grid item xs={12} alignItems='baseline' className={classes.flex}>
                  <div className={classes.inline}>
                    ...
                    <Link to='/' className={classes.link}> 
                        ...
                        <span className={classes.tagline}>Lift Dashboard</span>
                       </Link> 
                    </Typography>
                  </div>
                  { !this.props.noTabs && (
                    <React.Fragment>
                      ...
                      <div className={classes.tabContainer}>
                        ...
                        >
                          {Menu.map((item, index) => (
                            <Tab key={index} component={Link} to={{pathname: item.pathname}} classes={{root: classes.tabItem}} label={item.label} />
                          ))}
                        </Tabs>
                      </div>
                    </React.Fragment>  
